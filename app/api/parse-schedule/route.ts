...
- kind: "event" for anything with a duration or a clear time block (workout, meeting, focus block). "instant" for a momentary reminder/ping with no duration. "task" for a to-do that is not really time-blocked.
